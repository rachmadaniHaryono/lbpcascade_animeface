"""A setuptools for lbpcascade_animeface.
...
shutil.copyfile('example/detect.py', 'lbpcascade_animeface')
...
setup(
    ...
    description='A sample Python project sample Python project',  # Optional
    ...
    install_requires=['opencv-python', 'Click>=7.0'],  # Optional
